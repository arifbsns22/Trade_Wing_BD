              ...
              child: Container(
                ...
                child: ClipRRect(
                  ...
                  child: BackdropFilter(
                    filter: ImageFilter.blur(sigmaY: blurY, sigmaX: blurX),
                    child: Container(
                      padding: paddingR,
                      ...
                      child: Padding(
                        ...
                        child: _CrystalNavigationBarBody(
                          items: items,
...
class _CrystalNavigationBarBody extends StatelessWidget {
  const _CrystalNavigationBarBody({
    required this.items,
