...
- **Use dynamic things** from `lib/uitls/constants/app_colors.dart` for colors and `lib/uitls/constants` for other stuffs.Also use `lib/uitls/theme/app_theme.dart` to get the theme data.
